    ...
    <BlockViewer header="Hero" :code="block1">
      <div class="grid grid-nogutter surface-section text-800">
        ...
        <div class="col-12 md:col-6 overflow-hidden">
          <img
            src="https://raw.githubusercontent.com/primefaces/sakai-react/master/public/images/blocks/hero/hero-1.png"
            alt="Image"
    ...
    >
      <div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
        <div class="text-center mb-5">
          <img
            src="https://raw.githubusercontent.com/primefaces/sakai-react/master/public/images/blocks/logos/hyper.svg"
            alt="Image"
            height="50"
            class="mb-3"
          />
...
<div class="grid grid-nogutter surface-section text-800">
    ...
    <div class="col-12 md:col-6 overflow-hidden">
        <img src="https://raw.githubusercontent.com/primefaces/sakai-react/master/public/images/blocks/hero/hero-1.png" alt="Image" class="md:ml-auto block md:h-full" style="clip-path: polygon(8% 0, 100% 0%, 100% 100%, 0 100%)">
    </div>
</div>`,
      block2: `
<div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
...
<div class="surface-card p-4 shadow-2 border-round w-full lg:w-6">
    <div class="text-center mb-5">
        <img src="https://raw.githubusercontent.com/primefaces/sakai-react/master/public/images/blocks/logos/hyper.svg" alt="Image" height="50" class="mb-3">
        <div class="text-900 text-3xl font-medium mb-3">Welcome Back</div>
